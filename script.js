...
function setGreeting() {
  ...
  if (hour < 12) {
    document.body.style.backgroundImage =
      'url("https://images.unsplash.com/photo-1465488867967-ffb57e7f0a89?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bW9ybmluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60")';
    greeting.innerHTML = "Good Morning";
  } else if (hour < 18) {
    document.body.style.backgroundImage =
      'url("https://images.unsplash.com/photo-1577257108037-e85032e84049?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1174&q=80")';
